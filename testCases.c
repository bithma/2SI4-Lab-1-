...
//=================Question 6================================   
    ...
    void TestQ6_Boundry(CuTest *tc) {
            int input = 0;
            int expected[0]={0},actual[100]={0};
            int expectedCount=0;
            int actualCount = Q6(input,actual);
            CuAssertIntEquals(tc, expectedCount, actualCount);
    	int i;
...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_boundry);
        ...
        SUITE_ADD_TEST(suite, TestQ3_Boundry);
        ...
        SUITE_ADD_TEST(suite, TestQ4_Boundry);
        ...
        SUITE_ADD_TEST(suite, TestQ6_Boundry);
